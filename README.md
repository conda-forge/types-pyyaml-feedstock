...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-pyyaml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13139&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-pyyaml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-pyyaml` can be installed with:

```
conda install types-pyyaml
```

It is possible to list all of the versions of `types-pyyaml` available on your platform with:
