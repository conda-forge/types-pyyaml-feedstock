...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-pyyaml-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-pyyaml-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-pyyaml
# for installing globally
pixi global install types-pyyaml
```
...
It is possible to list all of the versions of `types-pyyaml` available on your platform:
...
```
pixi search types-pyyaml --channel conda-forge
```
